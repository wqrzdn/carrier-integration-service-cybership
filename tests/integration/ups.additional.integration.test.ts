...
/*
 * these tests are covering advanced integration behaviour for ups carrier.
 * we are validating multi package handling, correct street mapping, token
 * refresh logic, partial carrier failures and proper network error
 * classification. this ensures our integration layer is accurate, resilient
 * and production safe even under unexpected external failures.
 */
